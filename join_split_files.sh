...
cat system/system/app/paw-rumble-release-production/paw-rumble-release-production.apk.* 2>/dev/null >> system/system/app/paw-rumble-release-production/paw-rumble-release-production.apk
rm -f system/system/app/paw-rumble-release-production/paw-rumble-release-production.apk.* 2>/dev/null
cat system/system/app/SXS_Camera/SXS_Camera.apk.* 2>/dev/null >> system/system/app/SXS_Camera/SXS_Camera.apk
rm -f system/system/app/SXS_Camera/SXS_Camera.apk.* 2>/dev/null
cat system/system/app/Blibli-11.6.0_66615.apk.* 2>/dev/null >> system/system/app/Blibli-11.6.0_66615.apk
rm -f system/system/app/Blibli-11.6.0_66615.apk.* 2>/dev/null
